...
function home() {
  return shell(`<main id="main">
    ...
    <section class="product-preview" aria-labelledby="preview-title"><div class="section-intro"><p class="kicker">The control in one glance</p><h2 id="preview-title">See the peak before it surprises you</h2><p>This preview starts with an example reading. Move the peak limit to place the red marker.</p></div>${meterMarkup()}</section>
